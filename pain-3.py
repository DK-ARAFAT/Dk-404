...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            ARAFAT HOSSAIN 
     \033[1;91m➣ \033[1;91mFACEBOOK   :            A R A F A T 
     \033[1;92m➣ \033[1;92mWHATSAPP   :            01909170***
     \033[1;91m➣ \033[1;91mGITHUB     :            DK-ARAFAT
...
a=requests.get("https://github.com/DK-ARAFAT/Broken/blob/main/Approval.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
